...
namespace Fohjin.DDD.MVC2Beta.Areas.Account.Controllers {
    ...
    public partial class DepositController {
        protected DepositController(Dummy d) { }
        ...
        public readonly string Name = "Deposit";
        ...
        public class ViewNames {
            public readonly string Show = "~/Areas/Account/Views/Deposit/Show.aspx";
        }
    }

    [CompilerGenerated]
    public class T4MVC_DepositController: Fohjin.DDD.MVC2Beta.Areas.Account.Controllers.DepositController {
        public T4MVC_DepositController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult Save(Fohjin.DDD.MVC2Beta.Areas.Account.Models.AccountActivityViewModel deposit) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Save);
            callInfo.RouteValues.Add("deposit", deposit);
            return callInfo;
        }
