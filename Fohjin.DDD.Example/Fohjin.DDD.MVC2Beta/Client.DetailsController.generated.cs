...
namespace Fohjin.DDD.MVC2Beta.Areas.Client.Controllers {
    ...
    public partial class DetailsController {
        ...
        public class ViewNames {
            public readonly string Show = "~/Areas/Client/Views/Details/Show.aspx";
        }
    }

    [CompilerGenerated]
    public class T4MVC_DetailsController: Fohjin.DDD.MVC2Beta.Areas.Client.Controllers.DetailsController {
