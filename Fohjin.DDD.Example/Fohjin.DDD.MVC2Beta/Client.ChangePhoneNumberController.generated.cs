...
namespace Fohjin.DDD.MVC2Beta.Areas.Client.Controllers {
    [CompilerGenerated]
    public partial class ChangePhoneNumberController {
        protected ChangePhoneNumberController(Dummy d) { }
        ...
        public readonly string Name = "ChangePhoneNumber";
        ...
        public class ViewNames {
            public readonly string Show = "~/Areas/Client/Views/ChangePhoneNumber/Show.aspx";
        }
    }

    [CompilerGenerated]
    public class T4MVC_ChangePhoneNumberController: Fohjin.DDD.MVC2Beta.Areas.Client.Controllers.ChangePhoneNumberController {
        public T4MVC_ChangePhoneNumberController() : base(Dummy.Instance) { }
